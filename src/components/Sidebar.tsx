            ...
            {navLinks.map((link) => {
              ...
              return (
                <li key={link.name} className="w-full">
                  <Link href={link.href} className={`flex items-center justify-center group-hover:justify-start w-full h-16 my-2 transition-colors duration-200 relative group-hover:px-6 ${isActive ? 'bg-[#F77F00] text-white' : 'hover:bg-[#004a70]'}`} onClick={() => setIsMobileMenuOpen(false)}>
        ...
        <div className="w-full mb-4">
          {status === 'authenticated' ? (
            <div className="py-4 group-hover:px-6">
              ...
              <button onClick={() => { signOut({ callbackUrl: '/' }); setIsMobileMenuOpen(false); }} className="flex items-center justify-center group-hover:justify-start w-full h-16 transition-colors duration-200 hover:bg-red-800 rounded-md">
            ...
            <Link href="/login" className="flex items-center justify-center group-hover:justify-start w-full h-16 transition-colors duration-200 hover:bg-[#004a70] rounded-md group-hover:px-6" onClick={() => setIsMobileMenuOpen(false)}>
